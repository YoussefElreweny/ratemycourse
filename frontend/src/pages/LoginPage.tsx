    ...
    <div className="min-h-[calc(100vh-64px)] flex items-center justify-center px-4">
      ...
      >
        <div className="text-center mb-10">
          ...
          <p className="text-zinc-500">Sign in to save your course progress and reviews.</p>
          <div className="mt-4 p-3 bg-emerald-50 rounded-xl border border-emerald-100 text-[10px] text-emerald-700 font-medium">
            Tip: Use <span className="font-bold">y.reweny@gmail.com</span> to log in as Admin.
          </div>
        </div>
        ...
        <div className="mt-8 pt-8 border-t border-zinc-100 text-center">
          <p className="text-sm text-zinc-500">
            Don't have an account? <Link to="/register" className="text-emerald-600 font-bold hover:underline">Register your faculty</Link>
          </p>
        </div>
      </motion.div>
    </div>
